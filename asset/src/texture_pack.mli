...
sig
  ...
  val texture_creation_fun : Tsdl.Sdl.renderer -> string -> Texture_wrapper.MTexture.t
  val texture_creation_from_text : Tsdl.Sdl.renderer
    -> int
    -> string
    -> int
    -> Tsdl.Sdl.color 
  ...
  val fetch_texture :
    Lru_cache.MLRUCache.Lru_cache.key ->
    Lru_cache.MLRUCache.cache_el Lru_cache.MLRUCache.Lru_cache.t ->
    (string -> Texture_wrapper.MTexture.t) ->
    (Texture_wrapper.MTexture.t -> unit) ->
    Texture_wrapper.MTexture.t *
    Lru_cache.MLRUCache.cache_el Lru_cache.MLRUCache.Lru_cache.t
